win:
	...
	gcc main.c src/*.c sulfur_libs/blt_libs/*.c src/bytecode/*.c -o build/sulfur -lm -fno-builtin-printf
	make stdlibs_win
...
linux_one_file:
	mkdir -p build
	mkdir -p build/libs
	gcc main.c src/*.c src/bytecode/*.c sulfur_libs/blt_libs/*.c sulfur_libs/std_libs/*.c sulfur_libs/std_libs/graphic/*.c -o build/sulfur -lm -fno-builtin-printf -lX11 -D ONE_FILE
